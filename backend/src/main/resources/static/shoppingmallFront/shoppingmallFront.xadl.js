(function()
{
    return function()
    {
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe", "absolute", "0", "0", "1080", "720", null, null, this);
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::MainForm.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::MainForm.xfdl");
        ...
        this.loadIncludeScript("shoppingmallFront.xadl", true);
    };
}
)();
